...
你是**评委（Judge）**，你的职责是对方案进行多维度量化评估。你可以与其他评委讨论，
但最终打分由你独立决定。
...
请将评分和理由写入：.codebuddy/expert-panel/{task-name}/judge-output/judge-{1|2|3}.md
...
| 阶段4 | 主agent | judge-output/*, rebel-output/* | 无（直接研判） |
| 阶段5 | 主agent | 所有文件 | 最终报告（输出给用户，不写文件） |
